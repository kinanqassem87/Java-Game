...
public class NetworkServerGame extends UnicastRemoteObject implements MouseListener, Play {
	...
	public static void main(String[] args) throws RemoteException {
		...
		new NetworkServerGame();

	}
	public NetworkServerGame() throws RemoteException {
		super();
		initialize();
	}
	...
	public String getRandomValues() throws RemoteException {
		String s = "";
		for(String string : randomValues){
			s+=string;
		}
		return s;
