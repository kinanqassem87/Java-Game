...
public class NetworkClientGame extends UnicastRemoteObject implements MouseListener, Play {
	...
	public static void main(String[] args) throws RemoteException {
		...
		new NetworkClientGame();

	}
	public NetworkClientGame() throws RemoteException {
		super();
		initialize();
	}
