...
public class KNetWorkClient extends UnicastRemoteObject implements MouseListener, Play{
	...
	private JButton getBtend() {
		if (btend == null) {
			btend = new JButton();
			btend.setBounds(new java.awt.Rectangle(306,288,82,24));
			btend.setText("end");
	...
	public KNetWorkClient(String p1) throws RemoteException {
		super();
		initialize();
		p1Name = p1;
	...
	public void mouseClicked(MouseEvent e) {
		...
		if (turn == 2) {
			...
			if (score1 + score2 == 9) {
				...
				String winner = (score2 > score1) ? "You Win" : "You Lose";
