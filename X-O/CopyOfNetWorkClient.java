...
public class CopyOfNetWorkClient extends UnicastRemoteObject implements MouseListener, Play{
	...
	public CopyOfNetWorkClient(String p1) throws RemoteException {
		super();
		initialize();
		p1Name = p1;
	...
	private JPanel getJContentPane() {
		if (jContentPane == null) {
			...
			map.put("21", la21);map.put("22", la22);map.put("23", la23);
